...
Ajax.Request.prototype = {
  ...
  responseIsSuccess: function() {
    if (!this.isSuccess && this.firefoxOnFailureBug) {
      throw "calling this method where there's and actual failure blows up in firefox"
    } else {
      return this.isSuccess;
    }
  },
...
function assertActiveAjaxRequest(requestUrl, message) {
	...
	assertNotUndefined("Could not find ajax request " + requestUrl + " (active AJAX requests: " +
		Utils.asString(ActiveAjaxRequests) + ")\n" + message, 
