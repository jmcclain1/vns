...
Rico.Corner = {
   ...
   _createCorner: function(bgColor) {
      var corner = document._createElement("div");
      corner.style.backgroundColor = (this._isTransparent() ? "transparent" : bgColor);
      return corner;
   },

   _createCornerSlice: function(color,bgColor, n, position) {
      var slice = document._createElement("span");
...
Rico.LiveGridScroller.prototype = {
   ...
   createScrollBar: function() {
      ...
      this.scrollerDiv  = document._createElement("div");
      ...
      this.heightDiv = document._createElement("div");
...
Rico.LiveGrid.prototype = {
   ...
   addLiveGridHtml: function() {
     ...
     if (this.table.getElementsByTagName("thead").length > 0){
       ...
       tableHeader.setAttribute('className', this.table.className+'_header');
