...
describe PasswordController, "#update" do
  ...
  it "should update password if validations succeeds" do put :update, :user_id => @user.to_param, :user => {:current_password => 'password', :password => 'new_password', :password_confirmation => 'new_password'}
