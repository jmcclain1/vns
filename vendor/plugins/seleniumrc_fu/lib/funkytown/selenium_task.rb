...
module Funkytown
  class SeleniumTask < FunkytownTask
    ...
    def check_requirements
      ...
      raise "HALT: we could not find a Selenium server jar at #{selenium_server_path}.  You can override this configuration option using the selenium_server_jar key in RAILS_ROOT/config/funkytown/default.yml." unless File.exist?(selenium_server_path)
    end
